...
Section Intro.
  ...
  Definition inDwn_pctxA (τ : E.Ty) τ' (n : nat) := ia_papp₂ (UValIE (S n) τ) (UValIE n τ) (downgradeA n 1 τ) (ia_pinl τ' I.tunit ia_phole).

  Definition inUnitDwn_pctx (n : nat) := inDwn_pctx E.tunit n.
  Definition inUnitDwn_pctxA (n : nat) := inDwn_pctxA E.tunit I.tunit n.
  ...
  Definition inBoolDwn_pctxA (n : nat) := inDwn_pctxA E.tbool I.tbool n.
  ...
  Definition inArrDwn_pctxA (τ1 τ2 : E.Ty) (n : nat) := inDwn_pctxA (E.tarr τ1 τ2) (I.tarr (UValIE n τ1) (UValIE n τ2)) n.
  ...
  Definition inSumDwn_pctxA (τ1 τ2 : E.Ty) (n : nat) := inDwn_pctxA (E.tsum τ1 τ2) (I.tsum (UValIE n τ1) (UValIE n τ2)) n.
  ...
  Definition inProdDwn_pctxA (τ1 τ2 : E.Ty) (n : nat) := inDwn_pctxA (E.tprod τ1 τ2) (I.tprod (UValIE n τ1) (UValIE n τ2)) n.
  ...
  Definition inRecDwn_pctxA (τ : E.Ty) (n : nat) := ia_phole.
...
Section IntroTypes.
  Lemma inUnitDwn_pctx_T {n Γ} : ⟪ i⊢ inUnitDwn_pctx n : Γ , I.tunit → Γ , UValIE n E.tunit ⟫.
  Proof.
    unfold inUnitDwn_pctx, inDwn_pctx.
    eauto using upgrade_T1, downgrade_T1, I.PCtxTyping with typing uval_typing tyvalid.
  Qed.

  Lemma inUnitDwn_T {n t Γ} : ⟪ Γ i⊢ t : I.tunit ⟫ → ⟪ Γ i⊢ inUnitDwn n t : UValIE n E.tunit ⟫.
  Proof.
    unfold inUnitDwn.
    eauto using inUnitDwn_pctx_T with typing.
  Qed.

  Lemma inBoolDwn_pctx_T {n Γ} : ⟪ i⊢ inBoolDwn_pctx n : Γ , I.tbool → Γ , UValIE n E.tbool ⟫.
  Proof.
    unfold inBoolDwn_pctx, inDwn_pctx.
    eauto using upgrade_T1, downgrade_T1, I.PCtxTyping with typing uval_typing tyvalid.
  Qed.

  Lemma inBoolDwn_T {n t Γ} : ⟪ Γ i⊢ t : I.tbool ⟫ → ⟪ Γ i⊢ inBoolDwn n t : UValIE n E.tbool ⟫.
  Proof.
    unfold inBoolDwn.
  ...
  Lemma inSumDwn_pctx_T {n Γ τ1 τ2} :
    ...
    ⟪ i⊢ inSumDwn_pctx τ1 τ2 n : Γ , UValIE n τ1 r⊎ UValIE n τ2 → Γ , UValIE n (E.tsum τ1 τ2) ⟫.
  Proof.
  ...
  Lemma inSumDwn_T {n t Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ Γ i⊢ t : UValIE n τ1 r⊎ UValIE n τ2 ⟫ → ⟪ Γ i⊢ inSumDwn τ1 τ2 n t : UValIE n (E.tsum τ1 τ2) ⟫.
  Proof.
    unfold inSumDwn.
  ...
  Lemma inProdDwn_pctx_T {n Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ i⊢ inProdDwn_pctx τ1 τ2 n : Γ , UValIE n τ1 r× UValIE n τ2 → Γ , UValIE n (E.tprod τ1 τ2) ⟫.
  Proof.
  ...
  Lemma inProdDwn_T {n t Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ Γ i⊢ t : UValIE n τ1 r× UValIE n τ2 ⟫ → ⟪ Γ i⊢ inProdDwn τ1 τ2 n t : UValIE n (E.tprod τ1 τ2) ⟫.
  Proof.
    unfold inProdDwn.
  ...
  Lemma inArrDwn_pctx_T {n Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ i⊢ inArrDwn_pctx τ1 τ2 n : Γ , (UValIE n τ1 r⇒ UValIE n τ2) → Γ , UValIE n (E.tarr τ1 τ2) ⟫.
  Proof.
  ...
  Lemma inArrDwn_T {n t Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ Γ i⊢ t : UValIE n τ1 r⇒ UValIE n τ2 ⟫ → ⟪ Γ i⊢ inArrDwn τ1 τ2 n t : UValIE n (E.tarr τ1 τ2) ⟫.
  Proof.
    unfold inArrDwn.
  ...
  Lemma inRecDwn_pctx_T {n Γ τ} :
    ValidTy (trec τ) ->
    ⟪ i⊢ inRecDwn_pctx τ n : Γ , (UValIE n τ[beta1 (E.trec τ)]) → Γ , UValIE n (E.trec τ) ⟫.
  Proof.
    intros (cτ & crτ).
    inversion crτ; subst.
    unfold inRecDwn_pctx, inDwn_pctx; cbn.
    rewrite UValIE_trec; E.crushValidTy.
  ...
  Lemma inRecDwn_T {n t Γ τ} :
    ValidTy (trec τ) ->
    ⟪ Γ i⊢ t : UValIE n τ[beta1 (E.trec τ)] ⟫ → ⟪ Γ i⊢ inRecDwn τ n t : UValIE n (E.trec τ) ⟫.
  Proof.
    unfold inRecDwn.
    eauto using inRecDwn_pctx_T with typing.
  Qed.

  Lemma inUnitDwn_pctxA_T {n Γ} : ⟪ ia⊢ inUnitDwn_pctxA n : Γ , I.tunit → Γ , UValIE n E.tunit ⟫.
  Proof.
    unfold inUnitDwn_pctxA, inDwn_pctxA.
    eauto using upgrade_annot_T1, downgrade_annot_T1, I.PCtxTypingAnnot, I.AnnotTyping, UValIE_valid with typing uval_typing tyvalid.
  Qed.

  Lemma inUnitDwnA_T {n t Γ} : ⟪ Γ ia⊢ t : I.tunit ⟫ → ⟪ Γ ia⊢ inUnitDwnA n t : UValIE n E.tunit ⟫.
  Proof.
    unfold inUnitDwnA.
    eauto using inUnitDwn_pctxA_T with typing.
  Qed.

  Lemma inBoolDwn_pctxA_T {n Γ} : ⟪ ia⊢ inBoolDwn_pctxA n : Γ , I.tbool → Γ , UValIE n E.tbool ⟫.
  Proof.
  ...
  Lemma inBoolDwnA_T {n t Γ} : ⟪ Γ ia⊢ t : I.tbool ⟫ → ⟪ Γ ia⊢ inBoolDwnA n t : UValIE n E.tbool ⟫.
  Proof.
    unfold inBoolDwnA.
  ...
  Lemma inSumDwn_pctxA_T {n Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ ia⊢ inSumDwn_pctxA τ1 τ2 n : Γ , UValIE n τ1 r⊎ UValIE n τ2 → Γ , UValIE n (E.tsum τ1 τ2) ⟫.
  Proof.
  ...
  Lemma inProdDwn_pctxA_T {n Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ ia⊢ inProdDwn_pctxA τ1 τ2 n : Γ , UValIE n τ1 r× UValIE n τ2 → Γ , UValIE n (E.tprod τ1 τ2) ⟫.
  Proof.
  ...
  Lemma inSumDwnA_T {n t Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ Γ ia⊢ t : UValIE n τ1 r⊎ UValIE n τ2 ⟫ → ⟪ Γ ia⊢ inSumDwnA τ1 τ2 n t : UValIE n (E.tsum τ1 τ2) ⟫.
  Proof.
    unfold inSumDwnA.
  ...
  Lemma inProdDwnA_T {n t Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ Γ ia⊢ t : UValIE n τ1 r× UValIE n τ2 ⟫ → ⟪ Γ ia⊢ inProdDwnA τ1 τ2 n t : UValIE n (E.tprod τ1 τ2) ⟫.
  Proof.
    unfold inProdDwnA.
  ...
  Lemma inArrDwn_pctxA_T {n Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ ia⊢ inArrDwn_pctxA τ1 τ2 n : Γ , (UValIE n τ1 r⇒ UValIE n τ2) → Γ , UValIE n (E.tarr τ1 τ2) ⟫.
  Proof.
  ...
  Lemma inArrDwnA_T {n t Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ Γ ia⊢ t : UValIE n τ1 r⇒ UValIE n τ2 ⟫ → ⟪ Γ ia⊢ inArrDwnA τ1 τ2 n t : UValIE n (E.tarr τ1 τ2) ⟫.
  Proof.
    unfold inArrDwnA.
  ...
  Lemma inRecDwn_pctxA_T {n Γ τ} :
    ValidTy (trec τ) ->
    ⟪ ia⊢ inRecDwn_pctxA τ n : Γ , (UValIE n τ[beta1 (E.trec τ)]) → Γ , UValIE n (E.trec τ) ⟫.
  Proof.
    intros (cτ & crτ).
    inversion crτ; subst.
  ...
  Lemma inRecDwnA_T {n t Γ τ} :
    ValidTy (trec τ) ->
    ⟪ Γ ia⊢ t : UValIE n τ[beta1 (E.trec τ)] ⟫ → ⟪ Γ ia⊢ inRecDwnA τ n t : UValIE n (E.trec τ) ⟫.
  Proof.
    unfold inRecDwnA.
...
Section Destruct.
  ...
  Definition caseUnitUp_pctxA (n : nat) := pctxA_cat (ia_papp₂ (UValIE n E.tunit) (UValIE (S n) E.tunit) (upgradeA n 1 E.tunit) ia_phole) (caseUnit_pctxA n).
  Definition caseBoolUp_pctx (n : nat) := pctx_cat (papp₂ (upgrade n 1 E.tbool) phole) caseBool_pctx.
  Definition caseBoolUp_pctxA (n : nat) := pctxA_cat (ia_papp₂ (UValIE n E.tbool) (UValIE (S n) E.tbool) (upgradeA n 1 E.tbool) ia_phole) (caseBool_pctxA n).
  Definition caseSumUp_pctx (n : nat) (τ1 τ2 : E.Ty) := pctx_cat (papp₂ (upgrade n 1 (E.tsum τ1 τ2)) phole) (caseSum_pctx n τ1 τ2).
  Definition caseSumUp_pctxA (n : nat) (τ1 τ2 : E.Ty) := pctxA_cat (ia_papp₂ (UValIE n (E.tsum τ1 τ2)) (UValIE (S n) (E.tsum τ1 τ2)) (upgradeA n 1 (E.tsum τ1 τ2)) ia_phole) (caseSum_pctxA n τ1 τ2).
  Definition caseProdUp_pctx (n : nat) (τ1 τ2 : E.Ty) := pctx_cat (papp₂ (upgrade n 1 (E.tprod τ1 τ2)) phole) (caseProd_pctx n τ1 τ2).
  Definition caseProdUp_pctxA (n : nat) (τ1 τ2 : E.Ty) := pctxA_cat (ia_papp₂ (UValIE n (E.tprod τ1 τ2)) (UValIE (S n) (E.tprod τ1 τ2)) (upgradeA n 1 (E.tprod τ1 τ2)) ia_phole) (caseProd_pctxA n τ1 τ2).
  Definition caseArrUp_pctx (n : nat) (τ1 τ2 : E.Ty) := pctx_cat (papp₂ (upgrade n 1 (E.tarr τ1 τ2)) phole) (caseArr_pctx n τ1 τ2).
  Definition caseArrUp_pctxA (n : nat) (τ1 τ2 : E.Ty) := pctxA_cat (ia_papp₂ (UValIE n (E.tarr τ1 τ2)) (UValIE (S n) (E.tarr τ1 τ2)) (upgradeA n 1 (E.tarr τ1 τ2)) ia_phole) (caseArr_pctxA n τ1 τ2).
  Definition caseRecUp_pctx (n : nat) (τ : E.Ty) := phole.
  Definition caseRecUp_pctxA (n : nat) (τ : E.Ty) := ia_phole.
...
Section DestructTypes.
  Lemma caseUnitUp_pctx_T {n Γ} : ⟪ i⊢ caseUnitUp_pctx n : Γ , UValIE n E.tunit → Γ , I.tunit ⟫.
  Proof.
    unfold caseUnitUp_pctx.
    eauto using caseUnit_pctx_T, upgrade_T1, downgrade_T1 with typing uval_typing tyvalid.
  Qed.

  Lemma caseUnitUp_T {n t Γ} : ⟪ Γ i⊢ t : UValIE n E.tunit ⟫ → ⟪ Γ i⊢ caseUnitUp n t : I.tunit ⟫.
  Proof.
    unfold caseUnitUp.
  ...
  Lemma caseBoolUp_pctx_T {n Γ} : ⟪ i⊢ caseBoolUp_pctx n : Γ , UValIE n E.tbool → Γ , I.tbool ⟫.
  Proof.
    unfold caseBoolUp_pctx.
    eauto using caseBool_pctx_T, upgrade_T1, downgrade_T1 with typing uval_typing tyvalid.
  Qed.

  Lemma caseBoolUp_T {n t Γ} : ⟪ Γ i⊢ t : UValIE n E.tbool ⟫ → ⟪ Γ i⊢ caseBoolUp n t : I.tbool ⟫.
  Proof.
    unfold caseBoolUp.
  ...
  Lemma caseSumUp_pctx_T {n Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ i⊢ caseSumUp_pctx n τ1 τ2 : Γ , UValIE n (E.tsum τ1 τ2) → Γ , UValIE n τ1 r⊎ UValIE n τ2 ⟫.
  Proof.
    unfold caseSumUp_pctx.
    I.crushTyping.
    eauto using upgrade_T1, downgrade_T1, UValIE_valid, caseSum_pctx_T with typing uval_typing tyvalid tyvalid2.
  Qed.
  ...
  Lemma caseSumUp_T {n t Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ Γ i⊢ t : UValIE n (E.tsum τ1 τ2) ⟫ → ⟪ Γ i⊢ caseSumUp n t τ1 τ2 : UValIE n τ1 r⊎ UValIE n τ2 ⟫.
  Proof.
    unfold caseSumUp.
  ...
  Lemma caseProdUp_pctx_T {n Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ i⊢ caseProdUp_pctx n τ1 τ2 : Γ , UValIE n (E.tprod τ1 τ2) → Γ , UValIE n τ1 r× UValIE n τ2 ⟫.
  Proof.
    unfold caseProdUp_pctx.
    eauto using caseProd_pctx_T, upgrade_T1, downgrade_T1 with typing uval_typing tyvalid tyvalid2.
  Qed.
  ...
  Lemma caseProdUp_T {n t Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ Γ i⊢ t : UValIE n (E.tprod τ1 τ2) ⟫ → ⟪ Γ i⊢ caseProdUp n t τ1 τ2 : UValIE n τ1 r× UValIE n τ2 ⟫.
  Proof.
    unfold caseProdUp.
  ...
  Lemma caseArrUp_pctx_T {n Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ i⊢ caseArrUp_pctx n τ1 τ2 : Γ , UValIE n (E.tarr τ1 τ2) → Γ , I.tarr (UValIE n τ1) (UValIE n τ2) ⟫.
  Proof.
    unfold caseArrUp_pctx.
    eauto using caseArr_pctx_T, upgrade_T1, downgrade_T1 with typing uval_typing tyvalid tyvalid2.
  Qed.
  ...
  Lemma caseArrUp_T {n t Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ Γ i⊢ t : UValIE n (E.tarr τ1 τ2) ⟫ → ⟪ Γ i⊢ caseArrUp n t τ1 τ2 : UValIE n τ1 r⇒ UValIE n τ2 ⟫.
  Proof.
    unfold caseArrUp.
  ...
  Lemma caseRecUp_pctx_T {n Γ τ} :
    ValidTy (trec τ) ->
    ⟪ i⊢ caseRecUp_pctx n τ : Γ , UValIE n (E.trec τ) → Γ , UValIE n τ[beta1 (E.trec τ)] ⟫.
  Proof.
    intros (cτ & crτ).
    inversion crτ; subst.
  ...
  Lemma caseRecUp_T {n t Γ τ} :
    ValidTy (trec τ) ->
    ⟪ Γ i⊢ t : UValIE n (E.trec τ) ⟫ → ⟪ Γ i⊢ caseRecUp n t τ : UValIE n τ[beta1 (E.trec τ)] ⟫.
  Proof.
    unfold caseRecUp.
    eauto using caseRecUp_pctx_T with typing tyvalid.
  Qed.

  Lemma caseUnitUp_pctxA_T {n Γ} : ⟪ ia⊢ caseUnitUp_pctxA n : Γ , UValIE n E.tunit → Γ , I.tunit ⟫.
  Proof.
    unfold caseUnitUp_pctxA.
    crushTypingIA;
      eauto using UValIE_valid with typing uval_typing tyvalid tyvalid2.
  Qed.

  Lemma caseUnitUpA_T {n t Γ} : ⟪ Γ ia⊢ t : UValIE n E.tunit ⟫ → ⟪ Γ ia⊢ caseUnitUpA n t : I.tunit ⟫.
  Proof.
    unfold caseUnitUpA.
    eauto using caseUnitUp_pctxA_T with typing tyvalid.
  Qed.

  Lemma caseBoolUp_pctxA_T {n Γ} : ⟪ ia⊢ caseBoolUp_pctxA n : Γ , UValIE n E.tbool → Γ , I.tbool ⟫.
  Proof.
  ...
  Lemma caseBoolUpA_T {n t Γ} : ⟪ Γ ia⊢ t : UValIE n E.tbool ⟫ → ⟪ Γ ia⊢ caseBoolUpA n t : I.tbool ⟫.
  Proof.
    unfold caseBoolUpA.
  ...
  Lemma caseProdUp_pctxA_T {n Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ ia⊢ caseProdUp_pctxA n τ1 τ2 : Γ , UValIE n (E.tprod τ1 τ2) → Γ , UValIE n τ1 r× UValIE n τ2 ⟫.
  Proof.
    unfold caseProdUp_pctxA.
    intros.
    eapply I.pctxtyping_cat_annot;
    eauto using I.pctxtyping_cat_annot, I.PCtxTypingAnnot, caseProd_pctxA_T, UValIE_valid with typing uval_typing tyvalid tyvalid2.
  Qed.

  Lemma caseProdUpA_T {n t Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ Γ ia⊢ t : UValIE n (E.tprod τ1 τ2) ⟫ → ⟪ Γ ia⊢ caseProdUpA n t τ1 τ2 : UValIE n τ1 r× UValIE n τ2 ⟫.
  Proof.
    unfold caseProdUpA.
  ...
  Lemma caseSumUp_pctxA_T {n Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ ia⊢ caseSumUp_pctxA n τ1 τ2 : Γ , UValIE n (E.tsum τ1 τ2) → Γ , UValIE n τ1 r⊎ UValIE n τ2 ⟫.
  Proof.
    unfold caseSumUp_pctxA.
    intros.
    eapply I.pctxtyping_cat_annot;
    I.crushTypingIA; crushValidTy_with_UVal.
    eapply (upgrade_annot_T1 (τ := _ r⊎ _)); crushValidTy.
    now eapply caseSum_pctxA_T.
  Qed.

  Lemma caseSumUpA_T {n t Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ Γ ia⊢ t : UValIE n (E.tsum τ1 τ2) ⟫ → ⟪ Γ ia⊢ caseSumUpA n t τ1 τ2 : UValIE n τ1 r⊎ UValIE n τ2 ⟫.
  Proof.
    unfold caseSumUpA.
  ...
  Lemma caseArrUp_pctxA_T {n Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ ia⊢ caseArrUp_pctxA n τ1 τ2 : Γ , UValIE n (E.tarr τ1 τ2) → Γ , I.tarr (UValIE n τ1) (UValIE n τ2) ⟫.
  Proof.
    ...
    I.crushTypingIA; crushValidTy_with_UVal.
    eapply (upgrade_annot_T1 (τ := _ r⇒ _)); crushValidTy.
    now eapply caseArr_pctxA_T.
  Qed.

  Lemma caseArrUpA_T {n t Γ τ1 τ2} :
    ValidTy τ1 -> ValidTy τ2 ->
    ⟪ Γ ia⊢ t : UValIE n (E.tarr τ1 τ2) ⟫ → ⟪ Γ ia⊢ caseArrUpA n t τ1 τ2 : UValIE n τ1 r⇒ UValIE n τ2 ⟫.
  Proof.
    unfold caseArrUpA.
  ...
  Lemma caseRecUp_pctxA_T {n Γ τ} :
    ValidTy (trec τ) ->
    ⟪ ia⊢ caseRecUp_pctxA n τ : Γ , UValIE n (E.trec τ) → Γ , UValIE n τ[beta1 (E.trec τ)] ⟫.
  Proof.
    intros (_ & crτ).
    inversion crτ; subst.
  ...
  Lemma caseRecUpA_T {n t Γ τ} :
    ValidTy (trec τ) ->
    ⟪ Γ ia⊢ t : UValIE n (E.trec τ) ⟫ → ⟪ Γ ia⊢ caseRecUpA n t τ : UValIE n τ[beta1 (E.trec τ)] ⟫.
  Proof.
    intros vτ.
    unfold caseRecUpA.
...
Section DestructProps.
  ...
  Proof.
    intros vτ1 vτ2 vr.
    apply invert_valrel_pEmulDV_arr in vr; trivial.
  ...
  Proof.
    ...
    - left. exists vs'.
      ...
      eapply (eval_from_eval₀ (eval_case_inl vvs')); I.inferContext; now cbn.
  Qed.
