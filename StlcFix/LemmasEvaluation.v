...
Lemma normal_evalStar {v t} : normal v -> evalStar v t -> v = t.
Proof.
  intros nv [|t' ev ets]; [reflexivity|].
  exfalso; eapply nv; eauto.
Qed.

Lemma value_evalStar {v t} : Value v -> evalStar v t -> v = t.
Proof.
...
Ltac crushStlcEval :=
  match goal with
    ...
    | [ |- ECtx (papp₂ _ _) ] => unfold ECtx
    | [ |- ECtx (pite₁ _ _ _) ] => unfold ECtx
    | [ |- ECtx (pcaseof₁ _ _ _) ] => unfold ECtx
    | [ |- ECtx (ppair₁ _ _) ] => unfold ECtx
    | [ |- ECtx (ppair₂ _ _) ] => unfold ECtx
    | [ |- ECtx (pproj₁ _) ] => unfold ECtx
    | [ |- ECtx (pproj₂ _) ] => unfold ECtx
    | [ |- ECtx (pinl _) ] => unfold ECtx
    | [ |- ECtx (pinr _) ] => unfold ECtx
    | [ |- ECtx phole ] => (unfold ECtx; exact I)
  end.
